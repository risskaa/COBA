...
<head>
  ...
  <title>UD. ALIYA KALIPUTU- Admin Panel</title>
  <?php 
    include "header.php";
        ...
        <div class="col s12 m6">
          <div class="card blue darken-1" style="width: 340px;">
            <div class="card-content white-text" style="height: 160px;">
              <center><span class="card-title ">Customer</span></center>
              <div class="grid">
            ...
            <div class="card-action left" style="width: 340px;">
              <center><a href="admin_manage_users.php">Manage Users</a></center>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style="width: 340px; height: 238px">
        <div class="col s12 m6">
          <div class="card amber darken-4" style="width: 340px;"> 
            <div class="card-content white-text" style="height: 160px;">
             <center><span class="card-title ">Products</span></center> 
              <div class="grid">
            ...
            <div class="card-action left" style="width: 340px;"></center>
              <center><a href="admin_manage_products.php">Manage Products</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style="width: 340px; height: 238px">
        <div class="col s12 m6">
          <div class="card green darken-1" style="width: 340px;">
            <div class="card-content white-text" style="height: 160px;">
            <center> <span class="card-title ">Total Orders</span></center>
              <div class="grid">
            ...
            <div class="card-action left" style="width: 340px;">
             <center> <a href="admin_view_orders.php">Manage Orders</a></center>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style="width: 340px; height: 238px">
        <div class="col s12 m6">
          <div class="card red lighten-1" style="width: 340px;">
            <div class="card-content white-text" style="height: 160px;">
             <center> <span class="card-title">Today's Orders</span></center>
              <div class="grid">
                <div id="order1">
                  <?php 
                    $sql = "SELECT M.*, O.*, P.* FROM Members M, Orders O, Payment P
           ...
           <center>  <a href="admin_view_orders.php">Manage Order</a></center>
            </div>
          </div>
        </div>
      </div>
