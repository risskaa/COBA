...
<div class="nav-wrapper" style="height: 100px">
  <nav style="height: 100px;">
    <div class="nav-wrapper black" style="box-shadow: 0px 0px 2px white;">
          <a href="index.php"><img src = "./static/logo.png" alt="logo" id="logo" class="brand-logo glow-image" height="120"/></a>
...
<script>
  ...
  $(document).ready(function(){
    $('input.autocomplete').autocomplete({
      data: {
        'Jenang': 'static/images/JENANG.jpg',
        'Madu Mongso': 'static/images/MADUORI.jpg',
        'Oleh-oleh Khas': 'static/images/kategori2.jpg',
      }
    });
  });
