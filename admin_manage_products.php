...
<head>
  ...
  <title>UD. ALIYA KALIPUTU - Manage Products Panel</title>
  <?php
    include "header.php"; 
  ...
  <div class="rounded-card-parent" style="margin-top: 100px">
    <div class="card rounded-card">
      <div class="card-content">
        <span class="card-title orange-text bold">Tambah Produk</span>
            ...
            <div class="col s6" style="padding-right: 40px;">
              <div class="row">
                <div class="input-field white-text">
                  ...
                  <label for="name" class="white-text">Nama Produk</label>
                </div>
              </div>
              <div class="row">
                <div class="input-field white-text">
              ...
              <div class="row">
                <div class="row">
                  <div class="input-field white-text col s12">
                    ...
                    <label for="description" class="white-text">Deskripsi</label>
                  </div>
                </div>
              </div>
            </div>
            <div class="col s6" style="padding-right: 40px;">
              <div class="row">
                <div class="input-field white-text">
                  ...
                  <select name="category" id="category">
                    ...
                    <option value=0>Jenang</option>
                    <option value=1>Madu Mongso</option>
                    <option value=2>Oleh-oleh Khas</option>
                  </select>
              ...
              <div class="row">
                <div class="input-field white-text">
                  ...
                  <input name="sellingprice" id="sellingprice" type="number" step=".0000" class="validate white-text" maxlength="30">
                  <label for="sellingprice" class="white-text">Harga</label>
                </div>
              </div>
              <div class="row">
                <div class="input-field white-text">
                  ...
                  <label for="quantityinstock" class="white-text">Stok</label>
                </div>
              </div>
            </div>
          </div>
