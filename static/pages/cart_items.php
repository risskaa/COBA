  ...
  <div class="col s8">
    <ul class="collapsible popout" id="cart">
      ...
      <?php
        ...
        {
          if ($cartItemCount <= 0) 
            echo("<h5 class='grey-text page-title'>Keranjang belanja kosong.</h5><h6 class='grey-text page-title'>
              <a href='product_catalogue.php?query='>Belanja Sekarang!</a></h6>");
    ...
    <div class="rounded-card-parent">
      <div class="card rounded-card">
        ...
        <form action="payment.php" method="GET">
          ...
          <button class="btn amber darken-3" style="margin-top: 20px; margin-left: 100px">
            Checkout
          </button>
