...
<head>
  ...
  <title>UD. ALIYA KALIPUTU - Edit Produk</title>
  <?php
    require "header.php";
...
<body>
  ...
  <div class="card rounded-card">
    ...
    <span class="card-title orange-text bold center" style="padding-left: 100px;">Edit Produk- <?php echo $name; ?></span>
        ...
        <div class="col s6" style="padding-right: 40px;">
          ...
          <div class="row">
            <div class="input-field white-text">
              ...
              <input name="sellingprice" id="sellingprice" type="number" step=".0" class="validate white-text" maxlength="30"
