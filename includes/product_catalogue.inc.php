<?php
  ...
  const CATEGORY_NAMES = ["Jenang", "Madu Mongso", "Oleh-oleh Khas"];
  const BRAND_NAMES = ["AE", "Aliya", "All It","Aliza" , "Fausta", "Joko SM", "Maura", "Muria", "Sa Bidji", "Sa Niki", "Sarita","Zayna"];
  const SORT_NAMES = ["Harga Terendah", "Harga Tertinggi"];
